...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-green-500/30 overflow-x-hidden transition-colors duration-500">
            ...
            {/* Navbar Dark Glass */}
            <header className="bg-slate-900/60 border-b border-slate-800/50 sticky top-0 z-50 px-6 py-4 flex justify-between items-center backdrop-blur-xl">
                <div className="flex items-center gap-2 text-green-500 font-black text-xl tracking-tighter">
                ...
                <button 
                    ...
                    className="bg-green-600 text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-green-500 transition-all shadow-lg shadow-green-900/20 active:scale-95"
                >
            ...
            <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 space-y-24">
                ...
                {/* Hero Section */}
                <section className="text-center space-y-8 pt-16 animate-in fade-in zoom-in duration-1000">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-[0.9] md:leading-[0.9]">
                    ...
                    <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button 
                            onClick={() => navigate('/dashboard')}
                            className="w-full sm:w-auto bg-white text-slate-950 px-10 py-5 rounded-2xl text-lg font-black hover:bg-green-500 hover:text-white transition-all shadow-2xl flex items-center justify-center gap-2 hover:-translate-y-1 active:scale-95"
                        >
                ...
                <section className="bg-slate-900/40 border border-orange-500/20 rounded-[2.5rem] p-8 backdrop-blur-md flex flex-col md:flex-row items-start md:items-center gap-8 group hover:border-orange-500/40 transition-colors">
                    ...
                    <div className="flex-1">
                        <h3 className="text-xl font-bold text-orange-200 mb-2">Plataforma em Desenvolvimento</h3>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-slate-900/60 border border-slate-800 rounded-[2.5rem] p-10 shadow-xl backdrop-blur-sm">
                    ...
                    <div className="bg-gradient-to-br from-green-600/20 to-teal-900/20 border border-green-500/20 rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden flex flex-col justify-center backdrop-blur-sm group">
                        <div className="relative z-10">
                            <div className="w-14 h-14 bg-white/10 text-white rounded-2xl flex items-center justify-center mb-8 border border-white/20 group-hover:rotate-12 transition-transform">
                                <Coffee size={28} />
                            </div>
                            <h3 className="text-3xl font-black mb-4">Mantenha o Projeto Vivo</h3>
                    ...
                    <div className="grid gap-4 max-w-3xl mx-auto">
                        {faqData.map((item, index) => (
                            ...
                            >
                                ...
                                >
                                    <span className={`font-bold text-sm md:text-base ${openFaq === index ? 'text-green-400' : 'text-slate-200'}`}>
                                        {item.question}
                                    </span>
                                    <ChevronDown 
                                        size={20} 
                ...
                {/* CTA Final */}
                <section className="bg-gradient-to-t from-green-900/20 to-transparent rounded-[3rem] p-12 text-center border border-green-500/10">
                    <h3 className="text-2xl font-black text-white mb-4">Pronto para formatar o seu trabalho?</h3>
                    <p className="text-slate-400 mb-8 max-w-lg mx-auto text-sm">Junte-se a outros estudantes do IFPA que já estão simplificando a sua vida académica.</p>
                    <button 
                        onClick={() => navigate('/dashboard')}
                        className="bg-green-600 text-white px-10 py-4 rounded-2xl font-black hover:bg-green-500 transition-all shadow-xl shadow-green-900/20 active:scale-95"
                    >
            ...
            <footer className="bg-slate-950 border-t border-slate-900 text-slate-600 py-16 text-center text-sm font-medium">
